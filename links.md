...
- id: BU_ACADEMIC_GUIDE_MATH_BA
  ...
  scope: university-external
  why: Official catalog page for the BA in Mathematical Sciences; authoritative requirements source used for all BA tracks.
  owner: Math UG Program
  last_checked: 2025-12-24
...
- id: BU_ACADEMIC_GUIDE_MATH_BS
  ...
  scope: university-external
  why: BU Academic Guide/Catalog entry for the BS in Mathematical Sciences (catalog-year specific; update annually).
  owner: Math UG Program
  last_checked: 2025-12-24
