...
→ [Mathematics Track (BA/BS)](pure-math/)
...
→ [Actuarial Science Track (BA/BS)](actuarial/)
...
→ [Data Science & Statistics Track (BA/BS)](data-science/)
...
- **You like proof-based “core math”** and want maximum flexibility → **Mathematics (BA)**  
- **You want a more intensive math program** and may consider graduate study → **Mathematics (BS)**  
- **You want a clearly professional pathway** with exams/internships as milestones → **Actuarial (BA/BS)**  
