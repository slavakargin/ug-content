...
The online form for **self-nomination** will be sent to all math majors by email. If you are a graduating student who has not received the email containing the link to the self-nomination form **4–5 weeks into the semester**, please contact the **Director of Undergraduate Studies**: [Contact information]({{BU_MATH_CONTACT_INFO}}).

The department also hosts a [local chapter]({{BU_PME_LOCAL_CHAPTER}}) of [Pi Mu Epsilon](https://pme-math.org/), the National Mathematics Honor Society.
...
- **Helen P. Beard Award for Excellence in Undergraduate Mathematics** — established by Gerald Miller ’67 in honor of Professor Emeritus Helen Pearl Beard (retired 1982; passed away January 2004). Presented to a junior or senior major who demonstrates qualities exemplified by Professor Beard.
...
- **Early Achievement Award** – Awarded to a freshman, sophomore, or junior mathematics major or minor who has demonstrated exceptional academic excellence, engagement in mathematical research, or other significant contributions to the mathematical community. Graduating seniors are not eligible.
